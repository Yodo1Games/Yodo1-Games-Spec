Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://sdk-artifacts.yodo1.com/Yodo1Suit/6.5.12/iOS/Release/Yodo1Suit-6.5.12.zip' }
  ...
  s.subspec 'Base' do |sub|
    ...
    sub.resource = s.name + '/Commons/Assets/**/*.bundle'
  ...
  s.subspec 'Analytics' do |sub|
    ...
    sub.subspec 'Core' do |sub1|
      ...
      sub1.dependency 'TAThirdParty','0.3.5'
    end
    ...
    sub.subspec 'Adjust' do |sub1|
      ...
      sub1.dependency 'Adjust', '5.5.3'
      sub1.dependency 'Adjust/AdjustGoogleOdm', '5.5.3'
      sub1.dependency 'GoogleAdsOnDeviceConversion'
  ...
  s.subspec 'Purchase' do |sub|
    ...
    sub.dependency 'Yodo1Suit/Analytics/Core',"#{s.version}"
    sub.dependency 'Yodo1Suit/UCenter',"#{s.version}"
#    sub.dependency 'Yodo1AgeRange', '1.0.0'
  end
...
#    sub.dependency 'Yodo1AgeRange', '1.0.0'
  ...
  s.subspec 'UnityCore' do |sub|
    ...
    sub.dependency 'Yodo1Suit/Replay/Core',"#{s.version}"
